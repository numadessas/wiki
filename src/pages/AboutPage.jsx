  ...
  return (
    <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
      <article style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', padding: '1.25rem 1.5rem', borderRadius: '14px', border: '1px solid var(--gray-200)', marginBottom: '2.5rem', background: 'var(--gray-50)', flexWrap: 'wrap' }}>
          <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'var(--orange)', flexShrink: 0, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem' }}>
            <img src="/wiki/images/numa-pfp.jpg" alt="Numa" style={{ width: '100%', height: '100%', objectFit: 'cover' }} onError={e => { e.target.style.display = 'none' }} />
          </div>
        ...
        <Body>
          {isPt ? <>Este wiki nasceu com o nome <strong>Computadores Fazem Arte</strong> — uma referência à música homônima, composta por <strong>Fred Zero Quatro</strong> e interpretada com <strong>Chico Science e Nação Zumbi</strong>. O verso captura algo essencial sobre a relação entre tecnologia e criação artística:</> : <>This wiki was born under the name <strong>Computadores Fazem Arte</strong> — a reference to the song of the same name, written by <strong>Fred Zero Quatro</strong> and performed with <strong>Chico Science e Nação Zumbi</strong>. The verse captures something essential about the relationship between technology and artistic creation:</>}
        </Body>
        ...
        <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', margin: '1.5rem 0', background: 'var(--gray-100)' }}>
          <iframe style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: 0 }} src="https://www.youtube.com/embed/KZg_m0z4NLI" title="Computadores Fazem Arte - Fred Zero Quatro com Chico Science e Nacao Zumbi" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
        </div>
        ...
        <Body>
          {isPt ? <>Como orientadora, Numa acompanhou três estudantes de graduação em diferentes áreas do conhecimento.</> : <>As advisor, Numa mentored three undergraduate students across different areas of knowledge.</>}
        </Body>
        ...
        <Body>
          {isPt ? <>Em 2025, a convite do <strong>Professor Leonardo Castillo</strong>, Numa ministrou a disciplina <em>Design para Web3</em> no curso de Design da UFPE — levando o conteúdo deste projeto diretamente para a educação formal em design.</> : <>In 2025, invited by <strong>Professor Leonardo Castillo</strong>, Numa taught the course <em>Design para Web3</em> within the Design undergraduate program at UFPE — bringing this project content directly into formal design education.</>}
        </Body>
        ...
        {[
          { venue: 'WebMedia 2024 — UFJF', title: isPt ? 'Material didático sobre Blockchain, Web3 e NFTs para comunidades de arte digital' : 'Educational material on Blockchain, Web3, and NFTs for digital art communities', url: 'https://books-sol.sbc.org.br/index.php/sbc/catalog/view/177/779/1513' },
          { venue: 'IMX Workshop 2024', title: 'Art and XR: Experiences With 3D Scanning and NFTs in Web 3.0 Education', url: 'https://sol.sbc.org.br/index.php/imxw/article/view/35239' },
        ].map(pub => (
          <div key={pub.url} style={{ padding: '1.25rem 1.5rem', borderRadius: '12px', border: '1px solid var(--gray-200)', marginBottom: '0.75rem' }}>
            <p style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.6rem', textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--orange)', marginBottom: '0.5rem' }}>{pub.venue}</p>
            <p style={{ fontFamily: 'Instrument Sans, sans-serif', fontWeight: 600, fontSize: '0.95rem', color: 'var(--gray-900)', marginBottom: '0.75rem', lineHeight: 1.3 }}>{pub.title}</p>
            <a href={pub.url} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', padding: '0.35rem 0.75rem', background: 'var(--orange)', color: 'white', fontFamily: 'Space Mono, monospace', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.06em', borderRadius: '6px', textDecoration: 'none' }}>
              {isPt ? 'Acessar →' : 'Access →'}
            </a>
          </div>
        ))}
