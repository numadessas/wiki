...
const internetGen = [
  ...
  "",
  "<div style=\"display:grid;grid-template-columns:180px 1fr;gap:1.5rem;align-items:start;margin:1.5rem 0\"><div><img src=\"/wiki/images/web3.jpg\" alt=\"Carteira Solflare\" style=\"width:100%;border-radius:8px\" /><p style=\"font-family:'Space Mono',monospace;font-size:0.65rem;text-transform:uppercase;letter-spacing:0.08em;color:var(--gray-400);margin-top:0.5rem;text-align:center\">Carteira Solflare</p></div><div>",
  "",
