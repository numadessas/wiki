...
const internetGen = [
  ...
  "  </tr>",
  "  <tr>",
  "    <td style=\"padding:0.4rem 1rem 0.8rem;font-size:0.9rem;color:var(--gray-700)\">Internet Simples</td>",
  "    <td style=\"padding:0.4rem 1rem 0.8rem;font-size:0.9rem;color:var(--gray-700)\">Internet Social</td>",
  "    <td style=\"padding:0.4rem 1rem 0.8rem;font-size:0.9rem;color:var(--gray-700)\">Internet Semântica</td>",
  "  </tr>",
  "</table></div>",
  "",
  "## Web 1.0 — A Internet Simples",
  "",
  "<figure style=\"margin:1.5rem 0\"><img src=\"/wiki/images/web1.jpg\" alt=\"Site antigo do Yahoo\" style=\"width:100%;border-radius:8px\" /></figure>",
  "",
  ...
  "",
  "<figure style=\"margin:1.5rem 0\"><img src=\"/wiki/images/web2.jpg\" alt=\"Layout antigo do YouTube com o vídeo viral Charlie bit me\" style=\"width:100%;border-radius:8px\" /></figure>",
  "",
  ...
  "",
  "<figure style=\"float:left;margin:0 1.5rem 1rem 0;width:200px\"><img src=\"/wiki/images/web3.jpg\" alt=\"Carteira Solflare\" style=\"width:100%;border-radius:8px\" /></figure>",
  "",
