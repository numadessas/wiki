...
const security = [
  ...
  "## Golpes Comuns",
  "",
  "<div class=\"callout callout-warning\"><span class=\"callout-icon\">⚠️</span><div><p class=\"callout-title\">Perfis Falsos no Instagram</p>Se passam por colecionadores e oferecem preços altos pela sua obra, depois pedem uma taxa para finalizar a venda — que nunca acontece.</div></div>",
  "",
  "<div class=\"callout callout-warning\"><span class=\"callout-icon\">⚠️</span><div><p class=\"callout-title\">Propostas de Trabalho Falsas</p>Oferecem comissões ou testes de jogos com arquivos infectados com malware que vasculham o computador para invadir carteiras.</div></div>",
  "",
  "<div class=\"callout callout-warning\"><span class=\"callout-icon\">⚠️</span><div><p class=\"callout-title\">Sites Fraudulentos</p>Clones de projetos populares. Quando você conecta sua carteira, drenam todos os fundos.</div></div>",
  "",
  "---",
  "",
